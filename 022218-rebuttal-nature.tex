...
% So, in this sense, your intuition is correct and the weakly interacting phase essentially disappears deep in the percolation phase. 
% %But, maybe your question is about embedding a 2D random geometric graph in 3D, or ? 
...
%Sensitivity of the transition to a parameter requires that the parameter play a role on the number of links crossing a region of space compared to the number of nodes in that region of space. 
